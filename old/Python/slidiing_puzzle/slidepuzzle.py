...
def main():
    ...
    NEW_SURF,   NEW_RECT   = makeText('New Game', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 135, WINDOWHEIGHT - 60)
    SOLVE_SURF, SOLVE_RECT = makeText('Solve',    TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 135, WINDOWHEIGHT - 30)
...
def drawTile(tilex, tiley, number, adjx=0, adjy=0):
    ...
    left, top = getLeftTopOfTile(tilex, tiley)
    xpos = ((number - 1)% 4)*TILESIZE # x coord of image
    ypos = ((number - 1) // 4)*TILESIZE # y coord of image
    DISPLAYSURF.blit(IMAGE, (left + adjx, top + adjy), (xpos, ypos, TILESIZE, TILESIZE))
    textSurf = BASICFONT.render(str(number), True, TEXTCOLOR)
    textRect = textSurf.get_rect()
    textRect.center = left + int(TILESIZE / 6) + adjx, top + int(TILESIZE/1.2) + adjy # bottom left corner
